...
public class EntityImageStateBorder extends AbstractEntityImage {
	...
	final private EntityPosition entityPosition;

	public EntityImageStateBorder(ILeaf entity, ISkinParam skinParam) {
	...
	public void drawU(UGraphic ug, double xTheoricalPosition, double yTheoricalPosition) {
		...
		if (entityPosition == EntityPosition.ENTRY_POINT) {
			y -= 2 * RADIUS + dimDesc.getHeight();
		} else if (entityPosition == EntityPosition.EXIT_POINT) {
			y += 2 * RADIUS;
		}
		desc.drawU(ug, x, y);
